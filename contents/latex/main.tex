...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.25]{pictures/Green and White Colorful Minimalist Business Model Canvas Brainstorm.png}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{itemize}
\item Nội dung Kiến trúc hệ thống phân tích dữ liệu
\end{itemize}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
